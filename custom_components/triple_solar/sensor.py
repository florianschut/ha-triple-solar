...
async def async_setup_entry(
    ...
    sensors = [
        ...
        TripleSolarSensor(
            coordinator,
            "shModulationLevel",
            "Space Heating Modulation Level",
            "%",
            None,
            SensorStateClass.MEASUREMENT,
            "controller.spaceConditioning.heatingModulationLevels.heatPump",
        ),
        TripleSolarSensor(
            coordinator,
            "scModulationLevel",
            "Space Cooling Modulation Level",
            "%",
            None,
            SensorStateClass.MEASUREMENT,
            "controller.spaceConditioning.coolingModulationLevels.heatPump",
        ),
        TripleSolarSensor(
            coordinator,
            "dhwModulationLevel",
            "DHW Modulation Level",
            "%",
            None,
            SensorStateClass.MEASUREMENT,
            "controller.domesticHotWater.modulationLevels.heatPump",
        ),
        # Domestic Hot Water
        TripleSolarSensor(
            coordinator,
